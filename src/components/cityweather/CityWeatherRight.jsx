...
const CityWeatherRight = ({ e }) => {
  ...
  return (
    <div className={`w-[50%] transition-all ease-in-out duration-500  responsive10 h-10 flex ${DarkLight ? "text-[#5F7ABC]" : "text-white "}  `}>
      ...
      <div className="flex h-full flex-col  justify-between items-start">
        ...
        <p className={`transition-all ease-in-out duration-500 w-26 ${DarkLight ? "text-[#ABB9DF]" : "text-white"}`}>
