  ...
  return (
    <div className=" flex  justify-center items-center h-full w-[80%]">
      <input
       ...
       className={` placeholder:${DarkLight ? "text-gray-200" : "text-gray-500"} placeholder:text-sm  md:placeholder:text-xs h-[70%] w-[80%] shadow-[-10px_0px_10px_-10px_rgba(0,0,0,0.1)] ${DarkLight ? "text-white" : "text-black"} outline-none pl-4 rounded-bl-lg rounded-tl-lg ${DarkLight ? "border-[#252D3A]" : "border-[#E9EDF8]"} transition-all ease-in-out duration-500 border-2 border-r-0`}
      />
